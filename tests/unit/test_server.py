...
def test_fbmsg_post(client):
	data = {'object': 'page', 'entry': [{'messaging': [{'sender': {'id': '1845441168823830'}, 'recipient': {'id': '128995024567079'}, 'timestamp': 1517958975798, 'message': {'mid': 'mid.$cAAB1UabM_Axnnq0ZNlhbWe3KMXCq', 'seq': 327922, 'text': 'Hey'}}], 'time': 1517983946393, 'id': '128995024567079'}]}
